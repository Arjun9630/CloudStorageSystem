...
def upload_s3_file(user_id: str, file_content: bytes, key: str, content_type: str = "application/octet-stream"):
    """Uploads a file payload directly to S3 within the user's isolated folder."""
    try:
...
def get_presigned_url(s3_key: str, expires_in: int = 3600):
    """Generates a secure presigned URL for downloading/viewing the file."""
    try:
