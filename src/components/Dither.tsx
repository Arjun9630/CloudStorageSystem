...
class RetroEffectImpl extends Effect {
  ...
  set colorNum(value: number) {
    (this.uniforms as Map<string, THREE.Uniform<any>>).get('colorNum')!.value = value;
  }
  get colorNum(): number {
    return (this.uniforms as Map<string, THREE.Uniform<any>>).get('colorNum')!.value;
  }
  set pixelSize(value: number) {
    (this.uniforms as Map<string, THREE.Uniform<any>>).get('pixelSize')!.value = value;
  }
  get pixelSize(): number {
    return (this.uniforms as Map<string, THREE.Uniform<any>>).get('pixelSize')!.value;
  }
}
