...
function SidebarProvider({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, , { defaultOpen }, open, onOpenChange) {
    ...
    const setOpen = React.useCallback((value | ((value) => boolean)));
    {
    ...
    return (<SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div data-slot="sidebar-wrapper" style={{
            ...
            ...style,
        }.CSSProperties} className={cn("group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex min-h-svh w-full", className)} {...props}>
          {children}
        </div>
      </TooltipProvider>
    </SidebarContext.Provider>);
}
function Sidebar({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, , { side }, variant, collapsible) {
...
function SidebarGroupLabel({ className, asChild = false, ...props }, , { asChild }) {
...
function SidebarGroupAction({ className, asChild = false, ...props }, , { asChild }) {
...
function SidebarMenuAction({ className, asChild = false, showOnHover = false, ...props }, , { asChild }, showOnHover) {
    const Comp = asChild ? Slot : "button";
...
function SidebarMenuSkeleton({ className, showIcon = false, ...props }, , { showIcon }) {
...
function SidebarMenuSubButton({ asChild = false, size = "md", isActive = false, className, ...props }, , { asChild }, size, isActive) {
