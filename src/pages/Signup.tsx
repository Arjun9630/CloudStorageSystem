        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-blue-600/90 backdrop-blur-sm text-white py-3 rounded-lg border border-blue-500/50 hover:bg-blue-600 hover:shadow-[0_0_20px_rgba(37,99,235,0.4)] transition-all font-medium disabled:opacity-50 disabled:cursor-not-allowed mt-2"
            >
